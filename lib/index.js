...
var ImagesUploader = function (_Component) {
	...
	function ImagesUploader(props) {
		...
		_this.buildPreviews = _this.buildPreviews.bind(_this);
		_this.loadImages = _this.loadImages.bind(_this).bind(_this);
		_this.handleFileDrop = _this.handleFileDrop.bind(_this);
		_this.buildButtonContent = _this.buildButtonContent.bind(_this);
		_this.buildClose = _this.buildClose.bind(_this);
